const profile = {
    name: '李云飞',
    role: '把研究、流程和产品落到真实场景的人',
    intro: '我目前在重庆大学继续做管理科学与工程方向的学习，也持续把 AI、数据分析、自动化和产品设计放进真实问题里测试。这个作品集尽量保留作品本来的气质，而不是把所有内容压扁成统一模板。',
    statement: '我更在意作品有没有解决问题、信息是否组织得清楚、以及是否能被别人真正拿去使用。',
    location: '重庆 / 可远程协作',
...
const practiceNotes = [
    '先判断内容主角，再决定版式，避免每个模块都长得一样重要。',
    '尽量让作品直接暴露文件、截图和过程，不靠堆砌概念形容词。',
    '对“系统感”和“审美感”都保留耐心，但不让装饰盖过内容本身。'
];
...
const collections = [
    ...
    },
    {
        ...
        detail: '虽然这一部分体量不大，但它能补足我在纯文档和纯产品之外的表达倾向: 我也会关心镜头、节奏和观感，而不只是功能本身。',
        year: '2025',
